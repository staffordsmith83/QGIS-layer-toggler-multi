...
class VisToggler:
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            # define an empty list to keep track of which shortcuts have been connected
            self.connected_list = []
        ...
        # REFRESH: disconnect all connected shortcuts using self.connected_list
        for item in self.connected_list:
            self.disconnect_shortcut(self.shortcut_list[item])
        # Clear the list. NB cannot do this in the for loop
        # as you cannot modify a list length while iterating over it.
        self.connected_list = []
        ...
        if result:
            ...
            # keep track of which shortcuts were connected in a list
            self.connected_list = []
            for counter, comboBox in enumerate(self.comboBox_list):
                if comboBox.currentLayer():
                    self.connected_list.append(counter)
